    ...
    $element = array(
      'element' => array(
        ...
        '#attributes' => array(
          ...
          'src' => file_create_url(drupal_get_path('theme', 'importacionesgm') . '/js/html5shiv-printshiv.js'),
        ),
      ),
    );
    $html5shim = array(
 ...
 */
function importacionesgm_html_head_alter(&$head_elements) {
 ...
 */
function importacionesgm_page_alter(&$page) {
...
function importacionesgm_preprocess_node(&$vars) {
  // Add a striping class.
  $vars['classes_array'][] = 'node-' . $vars['zebra'];
}

function importacionesgm_preprocess_block(&$vars, $hook) {
  // Add a striping class.
